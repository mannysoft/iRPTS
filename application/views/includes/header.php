...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang=""><head>
	...
	<link href="<?php echo base_url();?>images/favicon.ico" rel="shortcut icon"><title>Integrated Real Property Tax System <?php echo $this->Settings->get_selected_field('version');?></title>
...
<!--<script src="<?php echo base_url();?>assets/ckeditor/_samples/sample.js" type="text/javascript"></script>-->
<!--<link href="<?php echo base_url();?>assets/ckeditor/_samples/sample.css" rel="stylesheet" type="text/css" />-->
...
<div class="system_name"><br />&nbsp;&nbsp;&nbsp;<span class="integrated">Integrated </span>Real Property Tax System<span class="version"> ver. <?php echo $this->Settings->get_selected_field('version');?></span></div>
</div>
