...
<td align="right">
<a href="<?php echo base_url();?>index.php/Leave_Manage/cancel_leave/<?php echo $manual_log_id.'/'.$employee_id.'/0/0';?>" onclick="return confirm_msg('Are you sure you want to cancel this Leave?\n Click OK to proceed otherwise click Cancel.');">Cancel</a> | 
<a href="<?php echo base_url();?>index.php/Leave_Manage/cancel_leave/<?php echo $manual_log_id.'/'.$employee_id.'/1/0';?>" onclick="return confirm_msg('Are you sure you want to cancel this Leave?\n Click OK to proceed otherwise click Cancel.');">Cancel(CSC)</a> | 
<a href="<?php echo base_url();?>index.php/Leave_Manage/cancel_leave/<?php echo $manual_log_id.'/'.$employee_id.'/0/1';?>" onclick="return confirm_msg('Are you sure you want to cancel this Leave?\n Click OK to proceed otherwise click Cancel.');">Cancel(CPO)<?php //echo $_GET['q']; ?></a></td>
</tr>
<?php
} 
?><tr>
