<form id="myform" method="post" action="<?php echo base_url();?>index.php/Employee_Manage/list_employee" target="" enctype="multipart/form-data">
...
Include not active </strong></td>
    <td>&nbsp;</td>
    <td><a href="<?php echo base_url();?>index.php/Employee_Manage/add_employee">Add Employee</a></td>
  </tr>
  <tr>
...
<table width="100%" border="0" class="type-one">
    ...
    onmouseout ="this.bgColor = '<?php echo $bg;?>';this.style.color='#000000'">
        ...
        <td align="right" bgcolor="">
          <a href="<?php echo base_url();?>index.php/Employee_Manage/edit_employee/<?php echo $id.'/'.$office_id.'/'.$page;?>">Edit</a>
        <a href="#" onclick="delete_employee('<?php echo $id;?>','Delete Employee <?php echo $lname.', '.$fname?>?', '<?php echo base_url();?>index.php/Employee_Manage/delete_employee/<?php echo $id.'/'.$office_id.'/'.$page;?>')">Delete</a> <a href="#" onmouseover="Tip('<img src=\'<?php echo base_url();?>pics/<?php echo $pics;?>\'><br><center><?php echo $position;?></center>', SHADOW, true, TITLE, '<?php echo $fname.' '.$mname.' '.$lname.' Details';?>')" onmouseout="UnTip()" style="cursor: pointer;">Picture</a></td>
        </tr>
		<?php
