...
<table width="100%" border="0">
    <tr>
      ...
      <td width="2%"><input name="employee_id" type="hidden" id="employee_id" value="<?php echo $employee_id;?>" /></td>
      <td width="78%" align="left"><input name="id" type="text" class="ilaw" id="id" onfocus="this.style.margin = '0'; this.style.borderWidth = '2px'; this.style.backgroundColor = '#FFFFFF';" onblur="this.style.margin = '1px'; this.style.borderWidth = '1px'; this.style.backgroundColor = '#E9F0F5';" value="<?php echo set_value('id', $id); ?>" size="35" autocomplete="off"/>
    ...
    <tr>
      ...
      <div id="pics">
      <iframe src="<?php echo base_url().'index.php/Utility/show_image/'.$image_file_name;?>" name="upload_iframe" style="width: 230px; height: 230px; display: block;"></iframe></div></td>
    </tr>
    <tr>
