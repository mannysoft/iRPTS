...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="Copyright" content="Docebo srl"><link rel="Copyright" href="http://www.docebo.com/" title="Copyright Notice"><link href="<?php echo base_url();?>images/favicon.ico" rel="shortcut icon"><title>Integrated Real Property Tax System <?php echo $this->Settings->get_selected_field('version');?></title>
...
<body onload="document.myform.username.focus();"
    onunload="clockOnUnload()">
		...
		<div id="rowHeaderLogin">Integrated Real Property Tax System</div>
