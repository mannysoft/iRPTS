...
<table width="100%" border="0">
  <tr>
    ...
    <td align="right"><a href="<?php echo base_url();?>settings_manage/location/city_save">Add Municipality</a> &nbsp;</td>
  </tr>
  <tr>
    <td width="71%">&nbsp;</td>
    <td width="4%">&nbsp;</td>
...
<table width="100%" border="0" class="type-one">
    ...
    onmouseout ="this.bgColor = '<?php echo $bg;?>';">
        ...
        <td bgcolor=""><?php echo $p->description?></td>
        <td bgcolor=""><?php echo $row->status;?></td>
        <td bgcolor="">
          <a href="<?php echo base_url();?>settings_manage/location/city_save/<?php echo $row->id;?>">Edit</a> | 
		  <a href="#" onclick="delete_user('<?php echo $row->username;?>','Delete City <?php echo $row->code;?>?', '<?php echo base_url();?>settings_manage/location/city_delete/<?php echo $row->id;?>')">Delete</a>
        </td>
        </tr>
		<?php endforeach;?>
      <tr>
