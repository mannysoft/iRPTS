...
<table width="100%" border="0" cellpadding="10" cellspacing="10">
  ...
  <tr>
    ...
    <td>
      <input name="code" type="text" id="code" value="<?php echo $land_class->code ?>" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right"><label for="description">Description:</label></td>
    <td><input name="description" type="text" id="description" value="<?php echo $land_class->description; ?>" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right">Assessment Level:</td>
    <td><input name="value" type="text" id="value" value="<?php echo $land_class->value; ?>" size="5" />
    %</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right" class="type-one">Status:</td>
      <?php $active = ''?>
      <?php $inactive = ''?>
	  <?php if($land_class->status == 'active' or $land_class->id == ''):?>
      	<?php $active = 'checked';?>
      <?php else:?>
  ...
  <tr>
    ...
    <td><input type="submit" name="encode_barangay" id="encode_barangay" value="Save" /> 
      <a href="<?php echo base_url();?>settings_manage/property/land_classes">Cancel</a></td>
