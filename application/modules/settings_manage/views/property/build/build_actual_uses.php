<table width="100%" border="0">
  <tr>
    <td width="10%">&nbsp;</td>
    <td width="67%">&nbsp;</td>
    <td width="23%"><a href="<?php echo base_url();?>settings_manage/property/plant_actual_uses_save/">Add new</a></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr>
...
<table width="100%" border="0" class="type-one">
  ...
  <tr bgcolor="<?php echo $bg;?>" onmouseover="this.bgColor = '<?php echo $this->config->item('mouseover_linecolor')?>';" 
    onmouseout ="this.bgColor = '<?php echo $bg;?>';">
        ...
        <a href="<?php echo base_url();?>settings_manage/property/plant_actual_uses_save/<?php echo $row->id;?>" class="edit_barangay">Edit</a> | <a href="#" onclick="delete_item('<?php echo $row->username;?>','Delete <?php echo $row->description;?>?', '<?php echo base_url();?>settings_manage/property/plant_actual_uses_delete/<?php echo $row->id;?>')">Delete</a></td>
        </tr>
		<?php endforeach;?>
        <tr>
          <td>
