<table width="100%" border="0">
  <tr>
    <td width="10%">&nbsp;</td>
    <td width="67%">&nbsp;</td>
    <td width="23%"><a href="<?php echo base_url();?>settings_manage/property/machine_depreciation_save/">Add new</a></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr>
...
<table width="100%" border="0" class="type-one">
      <tr class="type-one-header">
        ...
        <th bgcolor="#D6D6D6">Depreciation Rate (%)</th>
  ...
  <tr bgcolor="<?php echo $bg;?>" onmouseover="this.bgColor = '<?php echo $this->config->item('mouseover_linecolor')?>';" 
    onmouseout ="this.bgColor = '<?php echo $bg;?>';">
        ...
        <a href="<?php echo base_url();?>settings_manage/property/machine_depreciation_save/<?php echo $row->id;?>" class="edit_barangay">Edit</a> | <a href="#" onclick="delete_item('<?php echo $row->username;?>','Delete <?php echo $row->description;?>?', '<?php echo base_url();?>settings_manage/property/machine_depreciation_delete/<?php echo $row->id;?>')">Delete</a></td>
        </tr>
		<?php endforeach;?>
        <tr>
          <td>
