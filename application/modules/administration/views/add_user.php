...
<table width="100%" border="0" cellpadding="2">
    ...
    <tr>
      ...
      <td align="left" class="type-one"><?php echo form_dropdown('user_type', $user_type_options, $user_type_selected); ?>
      </td>
    ...
    <tr>
      ...
      <td align="left" class="type-one">
          <input name="repassword" type="password" id="repassword" size="35" class="ilaw" onfocus="this.style.margin = '0'; this.style.borderWidth = '2px'; this.style.backgroundColor = '#FFFFFF';" onblur="this.style.margin = '1px'; this.style.borderWidth = '1px'; this.style.backgroundColor = '#E9F0F5';"/></td>
      <td align="left">&nbsp;</td>
    </tr>
    <tr>
      <td align="right" class="type-one">&nbsp;</td>
