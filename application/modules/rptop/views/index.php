...
<table width="100%" border="0">
      ...
      <tr>
        <td><b>
          <input name="search_key" type="text" id="search_key" value="Search  Owner, RPTOPNumber, TDNumber" size="40" />
          <input type="submit" name="button" id="button" value="Go" />
        </b></td>
        <td>&nbsp;</td>
        <td><a href="<?php echo base_url().'index.php/rpu/add_rpu';?>" id="add_rpu">Add new</a></td>
      </tr>
    </table>
  ...
  <tr class="type-one-header">
    ...
    <th width="6%" bgcolor="#D6D6D6"><strong>Total Market Value</strong></th>
    <th width="6%" bgcolor="#D6D6D6"><strong>Total Assessed Value</strong></th>
  ...
  foreach ($rows as $row) 
{
  ...
  <tr bgcolor="<?php echo $bg;?>" onmouseover="this.bgColor = '#ABC7E9';this.style.color='#000000';" 
    ...
    <td><a href="<?php echo base_url().'rpu_manage/rptop_details/'.$row->owner_id;?>">Tax Declaration</a></td>
  </tr>
